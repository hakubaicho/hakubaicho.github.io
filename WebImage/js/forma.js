{
  ...
  function getJson_login(response){
    ...
    try{
      ...
      // ログイン後のエリアを表示
      debugConsole_forma_communication(keyOfToken);
          ...
          function( response  ) {
            ...
            switch(response)
            {
              case 0: //正常終了
                ...
                console.log(`item-uuid: ${item_from_camera_register}`);
                break;
              case 1: // 処理中
  ...
  function getJson_register_Item_PreSign(response){
    ...
    try{
      ...
      item_from_camera_register = obj.uuid;
      //------------------------------
      // デバッグ画面表示
      //------------------------------
