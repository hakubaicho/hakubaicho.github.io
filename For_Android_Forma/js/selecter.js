// 'use strict';
{
  ...
  const items = [
    // せなけいこ-ふうせんねこ
    new ClothItem('', '', 'S-001', 'img/book1-1.png','img/s0001.png','せなけいこ','ふうせんねこ',''),
    new ClothItem('', '', 'S-002', 'img/book1-2.png','img/s0002.png','せなけいこ','ふうせんねこ',''),

    // せなけいこ-ねないこだれだ
    new ClothItem('', '', 'S-003', 'img/book3-1.png','img/s0006.png','せなけいこ','ねないこだれだ',''),
    new ClothItem('', '', 'S-004', 'img/book3-2.png','img/s0007.png','せなけいこ','ねないこだれだ',''),
    new ClothItem('', '', 'S-005', 'img/book3-3.png','img/s0008.png','せなけいこ','ねないこだれだ',''),
    new ClothItem('', '', 'S-006', 'img/book3-4.png','img/s0009.png','せなけいこ','ねないこだれだ',''),
    new ClothItem('', '', 'S-007', 'img/book3-5.png','img/s0010.png','せなけいこ','ねないこだれだ',''),

      // せなけいこ-きれいなはこ
    new ClothItem('', '', 'S-008', 'img/book2-1.png','img/s0003.png','せなけいこ','きれいなはこ',''),
    new ClothItem('', '', 'S-009', 'img/book2-2.png','img/s0004.png','せなけいこ','きれいなはこ',''),
    new ClothItem('', '', 'S-010', 'img/book2-3.png','img/s0005.png','せなけいこ','きれいなはこ',''),

    // せなけいこ-いやだいやだ
    new ClothItem('', '', 'S-011', 'img/book4-1.png','img/s0011.png','せなけいこ','いやだいやだ',''),
    new ClothItem('', '', 'S-012', 'img/book4-2.png','img/s0012.png','せなけいこ','いやだいやだ',''),
    new ClothItem('', '', 'S-013', 'img/book4-3.png','img/s0013.png','せなけいこ','いやだいやだ',''),

    // せなけいこ-もじゃもじゃ
    new ClothItem('', '', 'S-014', 'img/book5-1.png','img/s0014.png','せなけいこ','もじゃもじゃ',''),
    new ClothItem('', '', 'S-015', 'img/book5-2.png','img/s0015.png','せなけいこ','もじゃもじゃ',''),
    new ClothItem('', '', 'S-016', 'img/book5-3.png','img/s0016.png','せなけいこ','もじゃもじゃ',''),

    // せなけいこ-にんじん
    new ClothItem('', '', 'S-017', 'img/book6-1.png','img/s0017.png','せなけいこ','にんじん',''),
    new ClothItem('', '', 'S-018', 'img/book6-2.png','img/s0018.png','せなけいこ','にんじん',''),
    new ClothItem('', '', 'S-019', 'img/book6-3.png','img/s0019.png','せなけいこ','にんじん',''),
    new ClothItem('', '', 'S-020', 'img/book6-4.png','img/s0020.png','せなけいこ','にんじん',''),
    new ClothItem('', '', 'S-021', 'img/book6-5.png','img/s0021.png','せなけいこ','にんじん',''),
    new ClothItem('', '', 'S-022', 'img/book6-6.png','img/s0022.png','せなけいこ','にんじん',''),
    new ClothItem('', '', 'S-023', 'img/book6-7.png','img/s0023.png','せなけいこ','にんじん',''),
    
    // せなけいこ-あーんあん
    new ClothItem('', '', 'S-024', 'img/book7-1.png','img/s0027.png','せなけいこ','あーんあん',''),
    new ClothItem('', '', 'S-025', 'img/book7-2.png','img/s0027.png','せなけいこ','あーんあん',''),
    new ClothItem('', '', 'S-026', 'img/book7-3.png','img/s0027.png','せなけいこ','あーんあん',''),
    
    // せなけいこ-ルルちゃんのくつした
    new ClothItem('', '', 'S-027', 'img/book8-1.png','img/s0027.png','せなけいこ','ルルちゃんのくつした',''),
    new ClothItem('', '', 'S-028', 'img/book8-2.png','img/s0028.png','せなけいこ','ルルちゃんのくつした',''),
    new ClothItem('', '', 'S-029', 'img/book8-3.png','img/s0029.png','せなけいこ','ルルちゃんのくつした',''),
    new ClothItem('', '', 'S-030', 'img/book8-4.png','img/s0030.png','せなけいこ','ルルちゃんのくつした',''),
    new ClothItem('', '', 'S-031', 'img/book8-5.png','img/s0031.png','せなけいこ','ルルちゃんのくつした',''),

    // せなけいこ-にゃんにゃん
    new ClothItem('', '', 'S-032', 'img/b1.png','','せなけいこ','にゃんにゃん',''),
    new ClothItem('', '', 'S-033', 'img/b2.png','','せなけいこ','にゃんにゃん',''),
    new ClothItem('', '', 'S-034', 'img/b3.png','','せなけいこ','にゃんにゃん',''),
    new ClothItem('', '', 'S-035', 'img/b4.png','','せなけいこ','にゃんにゃん',''),
    new ClothItem('', '', 'S-036', 'img/b5.png','','せなけいこ','にゃんにゃん',''),
    // ハトソン探偵団
    new ClothItem('', '', 'H-001', 'img/ht1.png','','ハトソン探偵団','ハトソンくん',''),
    new ClothItem('', '', 'H-002', 'img/ht5.png','','ハトソン探偵団','ハトソンくん',''),
    new ClothItem('', '', 'H-003', 'img/ht9.png','','ハトソン探偵団','ハトソンくん',''),
    new ClothItem('', '', 'H-004', 'img/ht13.png','','ハトソン探偵団','ハトソンくん',''),
    new ClothItem('', '', 'H-005', 'img/ht17.png','','ハトソン探偵団','ハトソンくん',''),

    new ClothItem('', '', 'H-006', 'img/ht2.png','','ハトソン探偵団','よろこビーバー',''),
    new ClothItem('', '', 'H-007', 'img/ht6.png','','ハトソン探偵団','よろこビーバー',''),
    new ClothItem('', '', 'H-008', 'img/ht10.png','','ハトソン探偵団','よろこビーバー',''),
    new ClothItem('', '', 'H-009', 'img/ht14.png','','ハトソン探偵団','よろこビーバー',''),
    new ClothItem('', '', 'H-010', 'img/ht18.png','','ハトソン探偵団','よろこビーバー',''),

    new ClothItem('', '', 'H-011', 'img/ht3.png','','ハトソン探偵団','ほしいゾウ',''),
    new ClothItem('', '', 'H-012', 'img/ht7.png','','ハトソン探偵団','ほしいゾウ',''),
    new ClothItem('', '', 'H-013', 'img/ht11.png','','ハトソン探偵団','ほしいゾウ',''),
    new ClothItem('', '', 'H-014', 'img/ht15.png','','ハトソン探偵団','ほしいゾウ',''),
    new ClothItem('', '', 'H-015', 'img/ht19.png','','ハトソン探偵団','ほしいゾウ',''),

    new ClothItem('', '', 'H-016', 'img/ht4.png','','ハトソン探偵団','オットセール',''),
    new ClothItem('', '', 'H-017', 'img/ht8.png','','ハトソン探偵団','オットセール',''),
    new ClothItem('', '', 'H-018', 'img/ht12.png','','ハトソン探偵団','オットセール',''),
    new ClothItem('', '', 'H-019', 'img/ht16.png','','ハトソン探偵団','オットセール',''),
    new ClothItem('', '', 'H-020', 'img/ht20.png','','ハトソン探偵団','オットセール',''),
