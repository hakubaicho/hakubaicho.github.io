// 'use strict';
{
  ...
  const items = [
    ...
    new ClothItem('fa036677-d583-418c-9c7e-31db4f830b73', 'ゆかた3', 'YKT003', 'img/YKT003.png','','TryOn', 'ゆかた',''),
    new ClothItem('a7ce30ad-048c-41b0-8161-e61092390b0d', 'ゆかた4', 'YKT004', 'img/YKT009.png','','TryOn', 'ゆかた',''),
  ];
